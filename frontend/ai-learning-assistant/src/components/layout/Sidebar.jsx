...
import { NavLink,useNavigate } from 'react-router-dom'//NavLink->Same as Link, but with active state support
...
const Sidebar = ({isSidebarOpen,toggleSidebar}) => {
  ...
  return ( <>
        ...
        <aside
            className={`fixed top-0 left-0 h-full w-64 bg-white/90 backdrop-blur-lg border-r border-slate-200/60 z-50 md:relative md:w-64 md:shrink-0 md:flex-col md:translate-x-0 transition-transform duration-300 ease-in-out ${
