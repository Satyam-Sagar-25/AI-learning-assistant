...
// useNavigate->you can change routes using JavaScript instead of clicking a link
            ...
            <div className="relative w-full max-w-md px-6">
                <div className="bg-white/80 backdrop-blur-xl border border-slate-200/60 rounded-3xl shadow-xl shadow-slate-200/50 p-10">
                    ...
                    <div className="space-y-5">
                        ...
                        <div className="space-y-2">
                            ...
                            <div className="relative group">
                                ...
                                <input
                                    ...
                                    onFocus={() => setFocusedField("email")}//Fires when the user clicks on the input or tabs into it.
									onBlur={()=> setFocusedField(null)}//Fires when the input loses focus (user clicks outside or tabs away)
						...
						{/* Error Message */}
						{error && ( //“If error is truthy, then render the JSX inside the parentheses.
						...
						<button
							...
							disabled={loading} //disabled till loading is true
						...
						>
							<span className="relative z-10 flex items-center justify-center gap-2">
								{loading ?(
									<>
										<div className="w-4 h-4 border-2 border-white/30 border-t-white rounded-full animate-spin"/> {/*This is a self-closing JSX tag. It means:Create an empty <div> with no children.*/}
										Signing in...
									</>
								):(
									<>
					...
					<div className="mt-8 pt-6 border-t border-slate-200/60">
						<p className="text-center text-sm text-slate-600">
							...
							<Link to={"/register"} className="font-semibold text-emerald-600 hover:text-emerald-700 transition-colors duration-200">Sign up</Link>
						</p>
					</div>
                </div>
				{/* Subtle footer text */}
