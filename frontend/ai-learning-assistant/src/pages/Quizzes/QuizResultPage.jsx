    ...
    <div className="max-w-5xl mx-auto">
      ...
      <div className="space-y-6">
        ...
        {detailedResults.map((result,index)=>{
          ...
          const correctAnswerIndex = result.correctAnswer.startsWith('0')//"02" → "2"
            ? parseInt(result.correctAnswer.substring(1)) - 1//Converts from 1-based        indexing to 0-based indexing.
