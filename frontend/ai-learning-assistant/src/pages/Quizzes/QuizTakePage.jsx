...
const QuizTakePage = () => {
  ...
  const handleOptionChange = (questionId,optionIndex)=>{
    setSelectedAnswers((prev)=>({//prev represents the previous state value of selectedAnswers
      ...prev,
      [questionId]:optionIndex,//If questionId already existed, it would overwrite its value.
    }));
  };
