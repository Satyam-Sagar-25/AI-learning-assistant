...
const axiosInstance = axios.create({//don’t have to repeat the same settings for every request
    baseURL: BASE_URL,
...
axiosInstance.interceptors.request.use(//It runs before every HTTP request is sent
    (config)=>{  //config is the request configuration object (URL, headers, body, etc.)
