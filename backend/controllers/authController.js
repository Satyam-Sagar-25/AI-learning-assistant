...
//Generate JWT token
const generateToken = (id)=>{//JWT lets the server prove “this user is logged in” without storing session data in memory or a database//*Jab tak ye token rahega tab tak user logged in rahega
