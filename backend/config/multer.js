...
if(!fs.existsSync(uploadDir)){//checks whether a directory or file already exists at the path stored in uploadDir.
...
const storage = multer.diskStorage({
    destination:(req,file,cb)=>{//file → metadata about the uploaded file (name, mimetype, etc.)
